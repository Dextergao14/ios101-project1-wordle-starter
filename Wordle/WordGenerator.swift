...
class WordGenerator {
  ...
  // Checkpoint: After finishing this exercise, you should now have a different goal word each time you run the app! Try printing out the selected goal word to check. If it's not working, check that you have done this exercise correctly.
    static let possibleWords = ["ABCDE", "APPLE", "BANANA", "CREATE", "DIVIDE",
    "ERASE", "FRANKLY", "GRATEFUL", "HUDDLE", "IDENTIFY", "JUSTIFY", "KOREA",
    "LUMINATED", "MODERATE", "NEW", "OPERATE", "PENCIL", "QUALITY", "RESPONSE",
    "STREET", "TAXI", "UTENSIL", "VICTORY", "WAIT", "XAVIER", "YOUNG", "ZOO"]
